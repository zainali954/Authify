...
export const AuthProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, setUser, isAuthenticated, setIsAuthenticated, isAdmin, setIsAdmin, error, Register, Login, logout, verifyEmail, resendVerificationEmail, ForgotPassword, ResetPassword }}>
      {children}
